...
public class Solution {
    ...
    public static void find(BinaryTreeNode<Integer> root,int k,String s,int sum){
       			if(root==null){
                    return;
                }
        ...
        find(root.left,k,s+root.data+" ",sum+root.data);
         find(root.right,k,s+root.data+" ",sum+root.data);
